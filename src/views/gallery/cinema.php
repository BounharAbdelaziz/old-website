                        ...
                        <form action="cinema.php" method="post">
                            <div class="filtre-ville ">
                                <select class="form-control " name="ville" id="ville">
                                    <option > all</option>
                                    <?php
                                        $query = "SELECT distinct ville FROM tbl_cinema  ORDER BY id DESC " ;
                        ...
                        <div class="row" >
                            ...
                            <?php
                                if (isset($_POST['filtre_btn'])){
                                    ...
                                    if ($true != 0) { 
                                        $query = "SELECT * FROM tbl_cinema WHERE ville LIKE '$ville'  ORDER BY id DESC " ;
                                    }
                                    else $query = "SELECT * FROM tbl_cinema  ORDER BY id DESC " ;
                                }
